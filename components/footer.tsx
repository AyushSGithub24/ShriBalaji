...
const footerLinks = {
  Products: [
    { name: "Outdoor Signage", href: "/category/outdoor-signage" },
    { name: "Corporate Stationery", href: "/category/corporate-stationery" },
    { name: "Premium Acrylic", href: "/category/premium-acrylic" },
    { name: "Interior Decor", href: "/category/interior-decor" },
    { name: "Recognition & Events", href: "/category/recognition-events" },
  ],
  Services: [
  ...
  return (
    <footer className="border-t border-border bg-card">
      <div className="mx-auto max-w-7xl px-4 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-2">
            ...
            <p className="text-sm text-muted-foreground mb-5 max-w-xs">
              ...
              premium signage and corporate branding solutions in Noida.
            </p>
            <div className="space-y-2">
              <div className="flex items-center gap-3 text-sm">
                <Phone className="h-5 w-5 text-primary shrink-0" />
                <a
                  href="tel:+919311055189"
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <a
                  href="mailto:shri_bljadv@yahoo.com"
                  className="text-muted-foreground hover:text-foreground transition-colors"
                >
                  shri_bljadv@yahoo.com
                </a>
              </div>
            </div>
          </div>
        ...
        {/* SEO Section - Hyper-Local Footer */}
        <div className="border-t border-border py-8">
          <div className="rounded-xl bg-secondary p-6">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Shri Balaji Advertising & Marketing specializes in industrial signages for Sector 62, 63, and corporate branding for 
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} SBA (Shri Balaji Advertising & Marketing). All rights reserved.
          </p>
